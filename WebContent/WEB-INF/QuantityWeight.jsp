		...
		<%@include file="nav.jsp"%>
	 	 ...
	 	 <c:choose>
				<c:when test="${queryType == 'common'}">
					<c:set var="queryUrl"
					value="QuantityWeight?type1=${classify1 }&searchContent1=${parameter1}&selected=&currentPage=">
					</c:set>
				</c:when>
				<c:when test="${queryType == 'singleSelect'}">
					<c:set var="queryUrl"
					value="GetQuantityWeightRoute?type1=${classify1 }&searchContent1=${parameter1}&selected=singleSelect&currentPage=">
					</c:set>
				</c:when>
				<c:otherwise>
					<c:set var="queryUrl"
					value="GetQuantityWeightRoute?type1=${classify1 }&searchContent1=${parameter1}&type2=${classify2}&searchContent2=${parameter2}&selected=mixSelect&currentPage=">
					</c:set>
				</c:otherwise>
