...
<body>
	...
	<div class="contain">
		...
		<div class="content">
			...
			<%@include file="nav.jsp"%>
				<!-- 面包屑 -->
				<div class="breadnav" style="margin-top:20px;margin-bottom: 8px;">
		            <span class="breadnav_logo"><img src="./image/breadnav_logo.png" alt=""></span>
		            <span class="BusinessPart">商务部</span>
		            <span class="QuotationSystemPart" >/ 报价系统</span>
		        </div>
		        
				<!-- 添加 -->
				<div class="choose lf" style="margin-top: 50px;">
					<input type="button" value=" " class="choose_addbtn"  onclick="AddContract()" style="margin: 10px 0 0px 0">
				</div>
				<!-- 模糊搜索 -->
		        <div class="search_box" style="display:none">
		        	<input type="text" class="search_con" name="" value="" >
			...
			<table id="table1" class="cf">
				<tr>
					<td class="table1_title1" style="min-width: 38px;width:3.8%;">序号</td>
					<!-- <td>修改</td> -->
					<!--删掉修改第2列改为报价日期eq(1)-->
				...
				<c:forEach var="orderInfo" items="${quotes}" varStatus="status">
					<c:if test="${status.index>0}">
						<tr class="tbody_tr">
							...
							<!--2  -->
							<td title="${orderInfo['Number']}" class="quote_Number" style="max-width: 130px;">${orderInfo['Number']}</td><!-- 4 -->
							<!--新增产品型号eq(5)-->
							<td title="${orderInfo['Model']}" class="quote_goodsModel">${orderInfo['Model']}</td><!-- 5 -->
							<td class="quote_StaffName">${orderInfo['StaffName']}</td><!-- 6 -->
							<!-- 报价单 -->
							<td><i class=" contract-show1"></i></td><!-- 7 -->
	...
	<div class="contract_add">
		<div class="addmodel_top">
			<span class="addmodel_title contract_title">添加报价需求</span>
			<span class="addmodel_logo"><img src="./image/goose_logo.png" alt="" /></span>
			<span class="addmodel_close contractAdd_close"></span>
		</div>
	
	
		<!-- <div class="contract_title"></div>
		...
		<div class="basic_info">
			...
			<table border="1" cellspacing="0" cellpadding="0"
				...
				<tbody>
					<tr>
						<td class="addInput_title">客户编号</td>
					...
					<tr>
						<td class="addInput_title"><span class="must_fill">*</span>客户名称</td>
					...
					<tr>
						<td class="addInput_title"><span class="must_fill">*</span>业务员</td>
					...
					<tr>
						<td class="addInput_title">交货方式</td>
						...
						<td class="addInput_title">有效期</td>
					...
					<tr>
						...
						<td class="addInput_title">课税类别</td>
					...
					<tr style="display: none;">
						<td class="addInput_title">业务员邮件</td>
						<td><input type="text" name="StaffMail" value=""
							class="StaffMail"></td>
						<td class="addInput_title">业务员电话</td>
						<td><input type="text" name="StaffTel" value=""
							class="StaffTel"></td>
						<td class="addInput_title">联络人邮件</td>
		...
		<div class="edit_btn">
			<input type="button" value="提交" class="" id="add_submit">
			<input type="button" value="取消" class="" id="add_cancel">
		</div>
	</div>

	<!-- 修改报价需求信息 -->
	<div class="contract_update">
		<div class="updatemodel_top">
			<span class="updatemodel_title contract_title">修改报价需求</span>
			<span class="updatemodel_logo"><img src="./image/goose_logo.png" alt="" /></span>
			<span class="updatemodel_close contractUpdate_close"></span>
		</div>
	
	<!-- 	<div class="contract_title">修改报价需求</div>
		...
		<div class="basic_info">
			...
			<table border="1" cellspacing="0" cellpadding="0"
				...
				<tbody>
					<tr>
						<td class="updateInput_title">客户编号</td>
						<td><input type="text" name="CustomerCode" value=""
							id="CustomerCode1"></td>
						<td style="text-align: left;"><i
					...
					<tr>
						<td class="updateInput_title">客户名称</td>
					...
					<tr>
						<td class="updateInput_title">联络人</td>
						<td><input type="text" name="CustomerName" value=""></td>
						<td class="updateInput_title">联络电话</td>
						<td><input type="text" name="CustomerTel" value=""></td>
						<td class="updateInput_title">联络传真</td>
						<td><input type="text" name="CustomerFax" value=""></td>
					</tr>

					<tr>
						<td class="updateInput_title">货期</td>
						<td><input type="text" name="LeadTime" value=""
							style="width: 136px;">weeks</td>
						<td class="updateInput_title">结账方式</td>
					...
					<tr>
						<td class="updateInput_title">业务员</td>
					...
					<tr>
						<td class="updateInput_title">交货方式</td>
						<td class="DeliveryWay" ><input type="text" name="DeliveryWay"
							value="" style="position: absolute; width: 162px;"
						...
						<td class="updateInput_title">汇率</td>
						<td class="ExchangeRate"><input type="text"
							name="ExchangeRate" value=""
						...
						<td class="updateInput_title">有效期</td>
						<td class="Valid"><input type="text" name="Valid" value=""
					...
					<tr>
						...
						<td class="updateInput_title">课税类别</td>
						...
						<td class="updateInput_title">报价版本号</td>
						<td><input type="text" name="Versions" value=""
							class="Versions"></td>
					</tr>
					<tr>
						<td class="updateInput_title">报价日期</td>
						<td><input type="text" value="" name="Datesent"
							class="Datesent" id="Datesent" disabled="disabled"></td>
						<td class="updateInput_title">报价单号</td>
						<td><input type="text" name="Number" value="" class="Number"
							id="Number" disabled="disabled"></td>
						<td class="updateInput_title">运输费用(USD)</td>
						<td><input type="text" name="ShipmentCost" value=""></td>
					</tr>
					<tr style="display: none;">
						<td class="updateInput_title">业务员邮件</td>
						<td><input type="text" name="StaffMail" value=""
							class="StaffMail"></td>
						<td class="updateInput_title">业务员电话</td>
						<td><input type="text" name="StaffTel" value=""
							class="StaffTel"></td>
						<td class="updateInput_title">联络人邮件</td>
						<td><input type="text" name="CustomerMail" value=""
							class="CustomerMail"></td>
					</tr>
				</tbody>
		...
		<div class="edit_btn">
			<input type="button" value="提交" class="" id="update_submit">
			<input type="button" value="取消" class="" id="update_cancel">
		</div>
	</div>
	...
	<div class="allHidePdf" style="display:none;">
		...
		<div id="costComparisonView" class="news" style="display:none;min-height:1200px;">
			...
			<div class="Sidebar_Price">
				...
				<div class="EgoMachine" id="EgoMachine" >华为Ego整机</div>
				<div class="EgoAccessories" id="EgoAccessories">华为Ego配件</div>
				<div class="costComparison" id="costComparison">成本对比表</div>
			</div>
			
			<input type="button" value="导出Excel" class="view_btn" id="exportEXCEL" style="position: absolute; z-index: 11; top: 150px; left: 75%; width: 92px; height: 30px; font-size: 19px;display:none;">
			<input type="button" value="导出Word" class="view_btn" id="exportWord1" style="position: absolute; z-index: 11; top: 150px; left: 75%; width: 92px; height: 30px; font-size: 19px;">
			<input type="button" value="导出PDF" class="view_btn" id="exportPDF1" style="position: absolute; z-index: 11; top: 200px; left: 75%; width: 92px; height: 30px; font-size: 19px;">
			<input type="button" value="关闭" class="view_btn " id="contract_close1" style="position: absolute; z-index: 11; top: 100px; left: 75%; width: 92px; height: 30px; font-size: 19px;">
			<input type="button" value="提交" class="view_btn" id="submit_n1" style="position: absolute; z-index: 11; top: 250px; left: 75%; width: 92px; height: 30px; font-size: 19px;">
		</div>
...
6.4、仲裁进行过程中，双方将继续执行合同，但仲裁部分除外。
		...
		<input type="button" value="关闭" class="view_btn " id="contract_close5" style="position: absolute; z-index: 11; top: 100px; left: 75%; width: 92px; height: 30px; font-size: 19px;">
		<input type="button" value="提交" class="view_btn" id="submit_n5" style="position: absolute; z-index: 11; top: 250px; left: 75%; width: 92px; height: 30px; font-size: 19px;">
		<input type="button" value="导出Word" class="view_btn" id="exportWord5" style="position: absolute; z-index: 11; top: 150px; left: 75%; width: 92px; height: 30px; font-size: 19px;">
		<input type="button" value="导出PDF" class="view_btn" id="exportPDF5" style="position: absolute; z-index: 11; top: 200px; left: 75%; width: 92px; height: 30px; font-size: 19px;">
	</div>
	...
	<div class="hidePdf7" style="display: none;">
		...
		<input type="button" value="关闭" class="view_btn " id="contract_close7" style="position: absolute; z-index: 11; top: 100px; left: 70%; width: 92px; height: 30px; font-size: 19px;">
		<input type="button" value="提交" class="view_btn" id="submit_n7" style="position: absolute; z-index: 11; top: 150px; left: 70%; width: 92px; height: 30px; font-size: 19px;">
		<input type="button" value="下载" class="view_btn" id="download7" style="position: absolute; z-index: 11; top: 200px; left: 70%; width: 92px; height: 30px; font-size: 19px;">
		<input type="button" value="备货" class="view_btn" id="Stocking" style="position: absolute; z-index: 11; top: 250px; left: 70%; width: 92px; height: 30px; font-size: 19px;">
	...
	<div class="CascadePOPdf" style="display: none;">
					...
					<table cellpadding="0" cellspacing="0" border="1"
						...
						<tr>
							<td><b>Bill To</b></br>
								...
								<p>Add:Suite 2, Room1201, 12/F., Chinachem Johnston Plaza, 178-186 Johnston Road, Wanchai, Hong Kong</p>
								<p>TEL:00852-29196861</p></td>
							<td><b>Vendor</b></br>
		...
		<input type="button" value="关闭" class="view_btn " id="CascadePO_close" style="position: absolute; z-index: 11; top: 100px; left: 75%; width: 92px; height: 30px; font-size: 19px;">
		<input type="button" value="提交" class="view_btn" id="CascadePO_submit" style="position: absolute; z-index: 11; top: 150px; left: 75%; width: 92px; height: 30px; font-size: 19px;">
		<input type="button" value="下载" class="view_btn" id="download8" style="position: absolute; z-index: 11; top: 200px; left: 75%; width: 92px; height: 30px; font-size: 19px;">
		<input type="button" value="发送" class="view_btn" id="PO_Send" style="position: absolute; z-index: 11; top: 250px; left: 75%; width: 92px; height: 30px; font-size: 19px;">
	</div>
	...
	<div class="contract_send" >
		...
		<div class="edit_btn">
			<input type="button" value="确定" class="" id="send_submit">
			<input type="button" value="取消" class="" id="send_cancel">
		</div>
	</div>
	<!-- CascadePO    发送-->
	<div class="contract_sendPO contract_sendPO1" style="display: none;">
		<div class="contractSendPO1_top">
			<span class=" contract_title">PO邮箱模板</span>
			<span class="addmodel_logo"><img src="./image/goose_logo.png" alt="" /></span>
			<span class=" contract_close"></span>
		</div>
...
Thanks for your support！
		...
		<div class="edit_btn edit_btn1">
			<input type="button" value="发送邮件" class="" id="send_submit1">
			<input type="button" value="取消发送" class="" id="send_cancel1">
		</div>
	</div>
	<!-- CascadePO    发送-->
	<div class="contract_sendPO contract_sendPO2" style="display: none;">
		...
		<div class="edit_btn edit_btn2">
			<input type="button" value="确定" class="" id="send_submit2">
			<input type="button" value="取消" class="" id="send_cancel2">
		</div>
	</div>
	
	<!--发货通知  模态框  -->
	<div class="ShipnoticeBox" style="display: none;">
		<div class="ShipnoticeBox_top">
			<span class="ShipnoticeBox_title contract_title">发货通知</span>
			<span class="ShipnoticeBox_logo"><img src="./image/goose_logo.png" alt="" /></span>
			<span class="ShipnoticeBox_close Shipnotice_close"></span>
		</div>
		...
		<div class="btnBox">
			<input type="button" value="提交通知" class="" id="Shipnotice_submit">
			<input type="button" value="取消更改" class="" id="Shipnotice_cancel">
		</div>
	</div>
...
<script src="js/quotelist.js?iv=201809301126"></script>
...
$('.eou-container-l a').after('').after('<h2 style="font-size:18px">futureE</h2>') */
	...
	function AddContract() {
		...
		$.ajax({
			...
			success : function(data) {
				...
				$('.MailBar_cover_color, .contract_add').slideDown(300);
			},
			error : function() {
	...
	$('.contractAdd_close').click(function() {
		$('.MailBar_cover_color').slideUp(300);
		$('.contract_add').slideUp(300);
		$(".ShipnoticeBox").slideUp(300);
	...
	$('#add_cancel').click(function() {
		$('.MailBar_cover_color, .contract_add').slideUp(300);
		$(".contract_add #tableADD_one input").val("");
	});
	...
	function PageJump(arg) {
		...
		var jumpNumber = $('.ui-paging-count').val() ;
...
function sales_quotation(){
	...
	$(".breadnav .BusinessPart").text("").text("销售部");
	$(".breadnav .QuotationSystemPart").text("").text("/ 销售报价系统");
}
...
//OtherPO文档显示
	...
	$(function(){
		/* 分页条  */
		var CurrentPage = $('#page #currentPage').text();
		var AllPage = $('#page #allPage').text();
