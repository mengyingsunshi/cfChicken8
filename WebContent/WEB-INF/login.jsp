			...
			<div class="container-r">
				<div class="menu">
					<form action="Login" method="post">
						...
						<div class="check7">
							<span class="checkspan"><input type="checkbox" checked="checked" id="check7"><label for="check7"></label></span>
							<span class="checktxt">Rember Me（7 Days）</span>
							<span title="上一版本号：v2.8.2.181225" style="font-size:14px">v2.8.3.190108</span>
						</div>
						<div class="sub-res">
