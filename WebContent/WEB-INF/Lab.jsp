...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="css/modules/laboratory/Lab-7157008f87.min.css" type="text/css">
		<link rel="stylesheet" type="text/css" href="css/paging.css" />
      <!--   <link rel="stylesheet" href="src/css/modules/laboratory/Lab.css" type="text/css"> -->
        <style>
            .u-admin a {
                ...
                <div id="NonStandard_sticker-con">
                    ...
                    <div class="container-fluid">
                        <div class="g_container">
                          ...
                          <div class="breadnav">
					            ...
					            <span class="labPart">实验室</span>
					            <span class="equipmentpart">/ 设备清单</span>
					        </div>
                            ...
                            <div class="g_body">
                                <div class="m_button">
                                    <div class="m_button_l">
                                        ...
                                        <span class="addLabInfo" value=""></span>
                                    </div>
                    ...
                    <div class="add_NonStandard" style="display: none;">
                    		<div class="addmodel_top ">
								<span class="addmodel_title ">添加设备清单</span>
								<span class="addmodel_logo"><img src="./image/goose_logo.png" alt="" /></span>
								<span class="addmodel_close add_NonStandard_tit_r"></span>
							</div>
                    ...
                    <div class="update_NonStandard" style="display: none;">
                    	<div class="updatemodel_top ">
								<span class="updatemodel_title ">修改设备清单</span>
								<span class="updatemodel_logo"><img src="./image/goose_logo.png" alt="" /></span>
								<span class="updatemodel_close update_NonStandard_tit_r"></span>
						</div>
                    ...
                    <div class="serviceReport_div">
                    		<div class=serviceReport_top>
								<span class="serviceReport_top_l">详细配置</span>
								<span class="serviceReport_logo"><img src="./image/goose_logo.png" alt="" /></span>
                           		 <div class="serviceReport_top_save">保存</div> 
                           		<div class="serviceReport_top_down">导出</div>
								<span class="serviceReport_top_r"></span>
							</div>
                        <!-- <div class="serviceReport_top">
    ...
    <script type="text/javascript" src="js/paging.js"></script>
        ...
        <script>
	    	...
	    	/* window.location.href = '/cfChicken8/Lab'; */
