			            ...
			            <div class="basic_info" style="padding-left:5%">
			                ...
			                <div class="table_body" style="margin-top:15px;margin-bottom:60px;">
			                	<div class="table_col1" style="float:left;width:24%;min-width:24%;padding-right:0%;">
			                         ...
			                         <span>
			                         	<select style="width:173px;height:25px;margin-bottom:20px;" name="Department"  id="Department">
			                	...
			                	<div  class="table_col3" style="float:left;width:30%;min-width:28%;padding-left:4%;">
			                		<span style="float:left;margin-right:5%">请假类别</span>
			                         <span>
			                         	<select style="width:200px;height:25px;margin-bottom:20px;" name="Classify"  id="Classify">
			                        	 <option text="请选择">请选择</option>
			                        ...
			                        <span style="float:left;margin-right:5%">请假事由</span>
			                         <span><textarea cols="26" rows="4" class="Reason"></textarea></span>
			                        <br>
			                        </div>
			                </div>
			                ...
			                <!-- <input type="text" class="ToList" style="margin-left:1%;margin-right:8.7%;width:15%;height:22px" value=""> -->
			                 <div style="display:inline-block;margin-left:1.1% ;margin-right:64px" class="ToBox" >
										<input type="search" class="To" style="width:170px;height:25px"> 
										<ul class="Tolist">
										</ul>
										</div>
							...
							<textarea type="text" name="MailContent" value="" class="MailContent" style="width:830px;height:100px;margin-left:5%;font-family: Microsoft YaHei;font-size: 14px;" contenteditable="true">XXX，您好！
此处填写请假邮件正文的内容。
祝好！
</textarea></p>
			        </div>
...
〡Phone: +86-512-62757360〡Web:www.eoulu.com〡Email:info@eoulu.com〡</pre>
			...
			<!-- <input type="button" value="提交" class="bToggle" id="submit_n" style="position:absolute;z-index:11;top: 250px; left: 70%;width: 92px;height: 30px;font-size: 19px;">
			 -->
			<input type="button" value="导出" class="bToggle ShowOrHide" id="exportPDF1" style="position:absolute;    border-radius: 15px;z-index:11;top: 150px; left: 70%;width: 92px;height: 30px;font-size: 19px;">
			<input type="button" value="关闭" class="bToggle " id="contract_close1" style="position: absolute;    border-radius: 15px;z-index: 11;top: 100px; left: 70%;width: 92px;height: 30px;font-size: 19px;">
	</div>
...
$(".contract_add span.passeye").click(function(){
    if ($(".contract_add .Password").attr("type") == "text") {
        ...
        $('.contract_add .passeye').css('background-image','url(./image/passeye.png)');
    }else{
      $(".contract_add .Password")[0].type = "text"; 
    	$('.contract_add .passeye').css('background-image','url(./image/passeye_psd.png)');
    }   
});
$(".contract_update2 span.passeye").click(function(){
    if ($(".contract_update2 .Password").attr("type") == "text") {
        ...
        $('.contract_update2 .passeye').css('background-image','url(./image/passeye.png)');
    }else{
      $(".contract_update2 .Password")[0].type = "text"; 
  		$('.contract_update2 .passeye').css('background-image','url(./image/passeye_psd.png)');
    }   
});
$(".contract_update .passeye").click(function(){
    if ($(".contract_update .Password2").attr("type") == "text") {
        ...
        $('.contract_update .passeye').css('background-image','url(./image/passeye.png)');
    }else{
      $(".contract_update .Password2")[0].type = "text"; 
		$('.contract_update .passeye').css('background-image','url(./image/passeye_psd.png)');
    }   
});
/****************** 跳页 **********************/
