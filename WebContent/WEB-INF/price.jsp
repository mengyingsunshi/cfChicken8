...
<div id="Price_wrapper">
    <div id="Price_sticker">
		...
		<!-- 	=======================实时汇率  结束 ================================== -->
					...
					<c:set var="totalSurplusValue" value="${(totalTargetValue-totalCompleteValue)}"></c:set>
						<div class="add-div-top">
							<span class="span span1">总目标值</span>
							<div class="number">${totalTargetValue}M</div>
							<c:if test="${totalSurplusValue >= 0}">
							...
							<c:if test="${totalSurplusValue < 0}">
								<c:set var="totalSurplusValue1" value="${(totalCompleteValue-totalTargetValue)}"></c:set>
								<span class="span span2">超额完成</span>
								<div class="number number2">
									<fmt:formatNumber type="number" value="${totalSurplusValue1}" pattern="#0.00" />M
								</div>
							</c:if>
						...
						<div class="prompt-content">
							<div class="prompt-top">
								<ul>
									...
									<c:if test="${totalSurplusValue < 0}">
										<li class="prompt-top2">超额完成：<b><fmt:formatNumber type="number" value="${totalSurplusValue1}" pattern="#0.00" />M</b></li>
									</c:if>
    ...
    <div id="Price_footer">
        <div id="eoulu-copy-out" style="height:40px;width:calc(100% - 2px);">
            ...
            <div id="eoulu-copy" style="width:100%;height:35px;font-size:12px;color:#888;line-height:35px;z-index: 2;">
                ...
                <div style="width:100%;text-align:center;display:inline-block;">Copyright  ©&nbsp;<span class="YEAR">2019</span>&nbsp<a href="http://www.eoulu.com/h-col-268.html" class="EHref" target="_blank" style="color:blue;">Eoulu</a> Tech. Co.,Ltd.</div>
            </div>
        </div>
    </div>
<!-- Price_wrapper结束 -->
