            ...
            <div id="originfactory_sticker-con">
                ...
                <!-- 	=======================导航栏   结束 ================================== -->
						...
						<div class="breadnav" style="margin-top:0px;margin-bottom: 8px;">
							            ...
							            <span class="BusinessPart">物流部</span>
							            <span class="QuotationSystemPart" >/ 资料库 / 供应商管理</span>
						</div>
                        ...
                        <form id="top_text_from" name="top_text_from" method="post" action="">
                            ...
                            <div class="choose" style="position: relative;">
                                <input type="button" value=" " class=" add_btn" onclick="AddContract()" style="margin: 0px 0 10px 0;">
                                <div class="search_div">
                                    <input type="text" placeholder="请选择" readonly="readonly" class="search_Column"><span class="down_span"></span>
                                    <select multiple style="width:100px;height:83px;display:none" id="selectCon">
                ...
                <div class="bankinfo_div" style="display: none;">
                    <div class="bankinfo_div_top">
                        ...
                        <div class="bankinfo_div_top_r"></div>
                    </div>
