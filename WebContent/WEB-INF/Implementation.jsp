...
<style>
	...
	#table1 th.ID, #table1 th.Type, #table1 th.delete_th, #table1 td.editTd, #table1 td.Type, #table1 td.delete_td {
		max-width: 40px;
		min-width: 40px;
		width: 40px;
		padding: 1px;
	...
	/* #table1 th.CustomerName, #table1 th.SoftwareVersion, #table1 td.CustomerName, #table1 td.SoftwareVersion {
		max-width: 150px;
		min-width: 150px;
		width: 150px;
	}
	
	#table1 th.Machine, #table1 td.Machine {
		max-width: 120px;
		min-width: 120px;
		width: 120px;
	} */

	#table1 th.InstallTime, #table1 th.ContinueTime, #table1 th.OperatingTime, #table1 th.detail_th, #table1 th.AreaName, #table1 td.InstallTime, #table1 td.ContinueTime, #table1 td.OperatingTime_td, #table1 td.record, #table1 td.AreaNameTd {
		max-width: 80px;
		min-width: 80px;
		width: 80px;
		padding: 1px;
			...
			<div class="contain">
				<div class="content">
					...
					<div style="display: none">
						<input type="text" value="" name="query_type"> <input type="text" value="" name="classify1"> <input type="text" value="" name="classify2"> <input type="text" value="" name="parameter1"> <input type="text" value="" name="parameter2">
					</div>
		            ...
		            <div class="saveSoftwareStaff" style="display: none;"></div>
		           	...
		           	<div class="addBtnDiv">
		           		...
		           		<input type="button" class="btn btn-info cancel_search" value="取消搜索">
		           	</div>
		           	<!-- 表格开始 -->
		           	<div class="gl_table_style_wrapper">
		           		<table class="gl_table_style" id="table1">
		           			<thead>
		           				<tr class="firstTr">
		           					<th class="ID">序号</th>
		           					<th class="CustomerName">客户单位</th>
		           					<th class="Contact">客户名称</th>
		           					<th class="Machine">机台</th>
		           					<th class="SoftwareVersion">软件版本</th>
		           					<th class="Type">类型</th>
		           					<th class="InstallTime">装机时间</th>
		           					<th class="ContinueTime">续期时间</th>
		           					<th class="OperatingTime">上次更新</th>
		           					<th class="progressStatus">进度</th>
		           					<th class="Engineer">工程师</th>
		           					<th class="detail_th">详细记录</th>
		           					<th style="display: none"></th>
		           					<th style="display: none"></th>
		           					<th style="display: none"></th>
		           					<th style="display: none"></th>
		           					<th style="display: none">InquiryID</th>
		           					<th class="AreaName">客户区域</th>
		           					<th class="delete_th">删除</th>
		           				</tr>
		           			</thead>
		           			<tbody>
		           				<c:forEach var="orderInfo" items="${datas}" varStatus="status">
		           					<c:if test="${status.index>0}">
		           						<tr>
		           							...
		           							<td class="OperatingTime_td" title="${orderInfo['OperatingTime']}">${orderInfo['OperatingTime']}</td>
		           							...
		           							<td class="delete_td"><span class="glyphicon glyphicon-trash delete_span" aria-hidden="true" value="${orderInfo['ID']}"></span></td>
		           						</tr>
		           					</c:if>
		           				</c:forEach>
		           			</tbody>
...
<script src="js/Implementation.js?iv=201809301009"></script>
</html>
