			...
			<table border="1" cellspacing="0" cellpadding="0" class="contract_basic">
				<tbody>	
					...
					<tr>
						...
						<td>产品类型</td>
						<td >
					 		<input type="text" name="ProductType" readonly="readonly" value="" style="position:absolute;width:160px;height:24px;"  id="ProductType_add" class="ProductType">
						  	<span>
			...
			<table border="1" cellspacing="0" cellpadding="0" class="contract_basic">
				<tbody>	
					...
					<tr>
						...
						<td>产品类型</td>
						<td >
					 		<input type="text" name="ProductType_update" value="" style="position:absolute;width:160px;height:24px;"  id="ProductType_update" class="ProductType_update">
						  	<span>
