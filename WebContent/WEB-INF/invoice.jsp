...
<!-- 						导出功能                    结束                                                                     -->
			...
			<table border="1" cellspacing="0" cellspadding="0" id="table1">
				<tr style="background: #bfbfbf;">
					<td style="width: 50px;max-width:60px">序号</td>
					...
					<td>货物名称</td>
					<td style="width: 100px;max-width:100px">模板预览</td>
					<!-- <td>导出pdf</td>	 -->
				...
				<c:forEach var="orderInfo" items="${invoice}" varStatus="status">
					<c:if test="${status.index>0}">
						<tr class="tbody_tr">
							...
							<td title="${orderInfo['ContractTitle']}" style="width:120px;">${orderInfo['ContractTitle']}</td>
							<td title="${orderInfo['ContractNO']}" style="width:140px;">${orderInfo['ContractNO']}</td>
			...
			<table border="1" cellspacing="0" cellpadding="0"
				...
				<tbody>
					...
					<tr>
						<td>Applicant</td>
						<td>
							<input type="text" name="Applicant" value="" style="position:absolute;width:152px;" id="Applicant">
							<span>
						...
						<td class="hideTD">
							<input type="text" name="ADD" value="" style="position:absolute;width:152px;" id="ADD">
							<span>
						...
						<td  class="hideTD">
							<input type="text" name="TEL" value="" style="position:absolute;width:152px;" id="TEL">
							<span>
					...
					<tr>
						...
						<td>From</td>
						<td>
							<input type="text" name="From" value="" style="position:absolute;width:152px;" id="From">
							<span>
						...
						<td>To</td>
						<td>
							<input type="text" name="To" value="" style="position:absolute;width:152px;" id="To">
							<span>
					...
					<tr>
						<td>Packing</td>
						<td>
							<input type="text" name="Packing" value="" style="position:absolute;width:152px;" id="Packing">
							<span>
						...
						<td>
							<input type="text" name="CountryofOrigin" value="" style="position:absolute;width:152px;" id="CountryofOrigin">
							<span>
						...
						<td>Manufacturer</td>
						<td>
							<input type="text" name="Manufacturer" value="" style="position:absolute;width:152px;" id="Manufacturer" >
							<span>
					...
					<tr>
						...
						<td>
							<input type="text" name="remarks"  style="width:152px;height:24px;position:absolute;" id="remarks" value="" >
							<span >
								<select onchange="document.getElementById('remarks').value=this.options[this.selectedIndex].text" style="width:174px;" >
									<option value="No" selected="selected">--请选择--</option>
					...
					<tr>
						...
						<td class="GoodsTd">
							<input type="text" name="Goods" value="" style="position:absolute;width:152px;" id="Goods1">
							<span>
						...
						<td>Unit</td>
						<td  class="UnitTd">
							<input type="text" name="Unit" value="SET" style="position:absolute;width:152px;" id="Unit1">
							<span>
			...
			<table border="1" cellspacing="0" cellpadding="0"
				...
				<tbody>
					...
					<tr>
						<td>Applicant</td>
						<td>
							<input type="text" name="Applicant" value="" style="position:absolute;width:152px;" id="Applicant1">
							<span>
								<select class="APPSelect">
									<option value="No"  selected="selected">--请选择--</option>
									<option value="100%">HOPE INVESTMENT DEVELOPMENT CORP., LTD.</option>
						...
						<td class="hideTD">Add</td>
						<td class="hideTD">
							<input type="text" name="ADD" value="" style="position:absolute;width:152px;" id="ADD1">
							<span>
						...
						<td  class="hideTD">TEL/FAX</td>
						<td  class="hideTD">
							<input type="text" name="TEL" value="" style="position:absolute;width:152px;" id="TEL1">
							<span>
					...
					<tr>
						...
						<td>From</td>
						<td>
							<input type="text" name="From" value="" style="position:absolute;width:152px;" id="From1">
							<span>
						...
						<td>To</td>
						<td>
							<input type="text" name="To" value="" style="position:absolute;width:152px;" id="To1">
							<span>
					...
					<tr>
						<td>Packing</td>
						<td>
							<input type="text" name="Packing" value="" style="position:absolute;width:152px;" id="Packing1">
							<span>
						...
						<td>Country of Origin </td>
						<td>
							<input type="text" name="CountryofOrigin" value="" style="position:absolute;width:152px;" id="CountryofOrigin1">
							<span>
						...
						<td>Manufacturer</td>
						<td>
							<input type="text" name="Manufacturer" value="" style="position:absolute;width:152px;" id="Manufacturer1" >
							<span>
					...
					<tr class="theLast">
						...
						<td>HS No/Terms of delivery and payment/Remark</td>
						<td>
							<input type="text" name="remarks"  style="width:152px;height:24px;position:absolute;" id="remarks1" value="" >
							<span >
								<select onchange="document.getElementById('remarks1').value=this.options[this.selectedIndex].text" style="width:174px;" >
									<option value="No" selected="selected">--请选择--</option>
									<option value="NA">NA</option>
									<option value="Data"  style="word-break:break-all">100% LC,90PCT OF CONTRACT VALUE SHOULD BE PAID AGAINST THE REQUIRED DOCUMENTS;10PCT OF CONTRACT VALUE SHOULD BE PAID AGAINST MANUALLY SIGNED COMMERCIAL INVOICE AND CERTIFICATE OF ACCEPTANCE TEST SIGNED BY THE APPLICANT AND THE BENEFICIARY.</option>
								</select>
	...
	<div class="hidePdf" style="display:none;">
				...
				<div id="view" class="news" style="font-family: initial;position:absolute;z-index:11;top:0;left:0;padding-top:30px;background:#fff;font-size:12px">
					<!-- 页眉-->
...
$(document).on("click",".contract-edit",function(){
	...
	$.ajax({
        ...
        success : function (data) {
        	$('.MailBar_cover_color, .contract_update').slideDown(400);
        	var itemStr ="";
        	 for(var i = 1 ; i <data.length; i++ ){
        		...
        		var sddStr = '<tr class="DIMTr DIMTrLen" value='+data[i].ID+'>'+
	        			...
	        			'<td><span style="color:red;">*</span>Description of Goods</td>'+
	        			'<td class="GoodsTd">'+
	        				'<input type="text" name="Goods" value="'+GoodsCon+'" style="position:absolute;width:152px;" class="GoodsCon">'+
	        				'<span>'+
	        				'	<select   class="GoodsSel" >'+
	        						'<option value="No" selected="selected">--请选择--</option>'+
	        						'<option value="SUMMIT12000B-S">SUMMIT12000B-S_</option>'+
	        			...
	        			'<td >Unit</td>'+
	        			'<td class="UnitTd">'+
	        				'<input type="text" name="Unit" value="'+data[i].Unit+'" style="position:absolute;width:152px;" class="UnitCon">'+
	        				'<span>'+
	        					'<select   class="UnitSel" >'+
	        						'<option value="No" selected="selected">--请选择--</option>'+
	        						'<option value="SET">SET</option>'+
...
var addStr ='<td><span style="color:red;">*</span>Description of Goods</td>'+
			'<td class="GoodsTd">'+
				'<input type="text" name="Goods" value="" style="position:absolute;width:152px;" class="GoodsCon">'+
				'<span>'+
				'	<select   class="GoodsSel" >'+
						'<option value="No" selected="selected">--请选择--</option>'+
						'<option value="SUMMIT12000B-S">SUMMIT12000B-S_</option>'+
			...
			'<td >Unit</td>'+
			'<td class="UnitTd">'+
				'<input type="text" name="Unit" value="SET" style="position:absolute;width:152px;"  class="UnitCon">'+
				'<span>'+
					'<select   class="UnitSel" >'+
						'<option value="No" selected="selected">--请选择--</option>'+
						'<option value="SET">SET</option>'+
...
function AddContract() {
    $('.MailBar_cover_color').slideDown(400);
    $('.contract_add .DIMTr,.contract_add .DIMTrNext').remove();
    $('.contract_add').slideDown(400);
