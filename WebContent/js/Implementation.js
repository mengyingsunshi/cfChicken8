...
$("#table1 .firstTr th").click(function(){
  var iClass = $(this).attr("class");
    if(iClass == undefined || iClass == "" || iClass == "ID" || iClass == "delete_th"){
        return;
    }else{
...
$(function() {
  ...
  $("#table1 .InstallTime, #table1 .ContinueTime, #table1 .OperatingTime_td").each(function(){
    var aa = $(this).text();
  ...
  $("#table1 .Progress").each(function(){
    ...
    if(curText==""||curText=="--"||curText=="0000-00-00"||curText==null||curText==undefined){
      $(this).siblings("td.ProgressStatus").css("color","rgba(255,0,0,0.9)");
    }else{
  ...
  $("#table1 .ProgressStatus").each(function(){
    ...
    if(that.text()!="100%"){
        that.parent().addClass("highlight_line");
    }
  });
...
$(".cancel_search").click(function(){
    window.location.assign(eouluGlobal.S_getCurPageHref());
});
