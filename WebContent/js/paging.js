...
(function(root, factory) {
	...
	Paging.prototype = {
		...
		format: function() {
			...
			html += '<li class="js-page-showCApage">' + this.current+'/'+this.pagecount + '</li>';
			html += '<li class=""> 到第</li>';
		...
		bindToolbar: function() {
			var _this = this;
			var html = $('<li class="ui-paging-toolbar"><select class="ui-select-pagesize" style="display:none;"></select><input type="text" class="ui-paging-count"/>页 <a href="javascript:void(0)" class="Gotojump">GO</a></li>');
