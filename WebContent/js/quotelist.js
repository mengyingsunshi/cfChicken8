...
//删除添加中的商品信息
$(document).on("click",".contract_add .Serial_del",function(){
	$(this).parent().parent().remove();
});

//删除修改中的商品信息
$(document).on("click",".contract_update .Serial_del",function(){
