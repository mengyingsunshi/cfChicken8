...
public class SoftwareProductServiceImpl implements SoftwareProductService{
	...
	public boolean operate(HttpServletRequest request) {
		...
		double hourlyWage = Double.parseDouble(request.getParameter("HourlyWage").equals("")?"0":request.getParameter("HourlyWage"));
		String classify = request.getParameter("PackageClassify");
		double cycle = Double.parseDouble(request.getParameter("Cycle").equals("")?"0":request.getParameter("Cycle"));
		...
		double transport = Double.parseDouble(request.getParameter("TransportAllowance").equals("")?"0":request.getParameter("TransportAllowance"));
		double accommodation = Double.parseDouble(request.getParameter("AccommodationAllowance").equals("")?"0":request.getParameter("AccommodationAllowance"));
		double mission = Double.parseDouble(request.getParameter("MissionAllowance").equals("")?"0":request.getParameter("MissionAllowance"));
	...
	public boolean delete(int id) {
		return new SoftwareProductDao().delete(id);
	}
