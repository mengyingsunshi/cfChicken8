...
public class RequirementServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("salesStatics", requirementService.getStatisticsBySales(startTime, endTime));
		request.setAttribute("areasStatics", requirementService.getStatisticsByArea(startTime, endTime));
