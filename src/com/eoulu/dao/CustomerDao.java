...
public class CustomerDao {
	...
	public List<Map<String,Object>> getAllCustomer(String content){
		String sql = "select t_customer.ID,t_customer.CustomerName,t_customer.Contact,t_customer.ContactInfo1 from t_customer where CustomerName like ? or Contact like ?";
		Object[] parameter = new Object[]{"%"+content+"%","%"+content+"%"};
